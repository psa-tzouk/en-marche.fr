...
Feature:
  ...
  Scenario: As a referent I can access the committee supervisors count managed by referent information
    ...
    When I send a "GET" request to "/api/statistics/committees/count-for-referent-area?email=referent@en-marche-dev.fr"
  ...
  Scenario: As a referent I can get the most active committees in referent managed zone
    ...
    And I send a "POST" request to "/oauth/v2/token" with parameters:
      ...
      | scope         | read:stats                                   |
    And I add the access token to the Authorization header
    When I send a "GET" request to "/api/statistics/committees/top-5-in-referent-area?email=referent@en-marche-dev.fr"
    Then the response status code should be 200
    And the response should be in JSON
    And the JSON should be equal to:
    """
  ...
  Scenario: As a referent I can get the committee members count in referent managed zone
    ...
    And I send a "POST" request to "/oauth/v2/token" with parameters:
      ...
      | scope         | read:stats                                   |
    And I add the access token to the Authorization header
    When I send a "GET" request to "/api/statistics/committees/members/count-by-month?email=referent-75-77@en-marche-dev.fr"
    Then the response status code should be 200
    And the response should be in JSON
    And the JSON should be equal to:
    """
    ...
    And I send a "POST" request to "/oauth/v2/token" with parameters:
      ...
      | scope         | read:stats                                   |
    And I add the access token to the Authorization header
    When I send a "GET" request to "/api/statistics/committees/members/count-by-month?email=referent-75-77@en-marche-dev.fr&country=fr"
    Then the response status code should be 200
    And the response should be in JSON
    And the JSON should be equal to:
    """
    ...
    And I send a "POST" request to "/oauth/v2/token" with parameters:
      ...
      | scope         | read:stats                                   |
    And I add the access token to the Authorization header
    When I send a "GET" request to "/api/statistics/committees/members/count-by-month?email=referent-75-77@en-marche-dev.fr&country=ch"
    Then the response status code should be 200
    And the response should be in JSON
    And the JSON should be equal to:
    """
    ...
    And I send a "POST" request to "/oauth/v2/token" with parameters:
      ...
      | scope         | read:stats                                   |
    And I add the access token to the Authorization header
    When I send a "GET" request to "/api/statistics/committees/members/count-by-month?email=referent-75-77@en-marche-dev.fr&city=Paris%208e"
    Then the response status code should be 200
    And the response should be in JSON
    And the JSON should be equal to:
    """
    ...
    And I send a "POST" request to "/oauth/v2/token" with parameters:
      ...
      | scope         | read:stats                                   |
    And I add the access token to the Authorization header
    When I send a "GET" request to "/api/statistics/committees/members/count-by-month?email=referent-75-77@en-marche-dev.fr&city=Dammarie-les-Lys"
    Then the response status code should be 200
    And the response should be in JSON
    And the JSON should be equal to:
    """
    ...
    And I send a "POST" request to "/oauth/v2/token" with parameters:
      ...
      | scope         | read:stats                                   |
    And I add the access token to the Authorization header
    When I send a "GET" request to "/api/statistics/committees/members/count-by-month?email=referent-75-77@en-marche-dev.fr&committee=515a56c0-bde8-56ef-b90c-4745b1c93818"
    Then the response status code should be 200
    And the response should be in JSON
    And the JSON should be equal to:
    """
    ...
    And I send a "POST" request to "/oauth/v2/token" with parameters:
      ...
      | scope         | read:stats                                   |
    And I add the access token to the Authorization header
    When I send a "GET" request to "/api/statistics/committees/members/count-by-month?email=referent-75-77@en-marche-dev.fr&committee=b0cd0e52-a5a4-410b-bba3-37afdd326a0a"
    Then the response status code should be 200
    And the response should be in JSON
    And the JSON should be equal to:
    """
